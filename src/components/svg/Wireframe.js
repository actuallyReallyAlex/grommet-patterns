...
const Wireframe = ({ size }) => {
  ...
  const height = (parseInt(width) * 0.7072).toString();
  return (
    <svg
    ...
    >
      ...
      <rect x="280.21" y="202.32" width="151" height="9" fill="#9060eb" />
      <rect x="280.21" y="465.32" width="151" height="9" fill="#9060eb" />
      <rect
        x="280.21"
        y="485.32"
        width="280"
      ...
      <rect
        ...
        fill="#9060eb"
      />
      <rect x="633.15" y="511.47" width="97.01" height="16.99" fill="#9060eb" />
      <ellipse
        cx="258.43"
        cy="775.37"
        rx="28.6"
