...
const Design = ({ size }) => {
  ...
  const height = (parseInt(width) * 0.7666).toString();
  return (
    <svg
    ...
    >
      ...
      <rect x="836.47" y="419.68" width="58.49" height="52.64" fill="#9060eb" />
      <rect x="924.2" y="618.53" width="58.49" height="52.64" fill="#9060eb" />
      <line
        x1="836.47"
        y1="502.86"
        x2="982.68"
